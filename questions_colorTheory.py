quiz_data = {
    "Color Theory": {
        ...
        "medium": [
            ...
            {"question": "The psychological effect of red (commonly associated with).", "answer": "Passion / Energy / Love"},
            ...
            {"question": "Another name for brightness in color.", "answer": "Brightness / Value"},
        ...
        "hard": [
            ...
            {"question": "List 6 tertiary colors.", "answer": "Red-Orange, Red-Violet, Blue-Green, Blue-Violet, Yellow-Orange, Yellow-Green"},
            {"question": "List 3 warm colors.", "answer": "Red, Orange, Yellow"},
            {"question": "List 3 cool colors.", "answer": "Blue, Green, Purple"},
            {"question": "List the 3 parts of a color (properties).", "answer": "Hue, Value, Saturation"},
            {"question": "List 3 types of color harmony.", "answer": "Complementary, Analogous, Triadic"},
            {"question": "List 3 complementary pairs of colors.", "answer": "Red–Green, Blue–Orange, Yellow–Purple"},
            {"question": "List 3 examples of analogous color schemes.", "answer": "Red, Red-Orange, Orange / Blue, Blue-Green, Green / Yellow, Yellow-Orange, Orange"},
            {"question": "List 3 neutral colors.", "answer": "Black, White, Gray"},
            {"question": "List the 3 colors in a triadic scheme of red.", "answer": "Red, Yellow, Blue"},
            {"question": "List the 3 colors in a triadic scheme of blue.", "answer": "Blue, Red, Yellow"},
            {"question": "List the 3 colors in a triadic scheme of yellow.", "answer": "Red, Blue, Yellow"},
